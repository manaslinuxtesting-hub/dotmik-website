...
import Logicwhychoose from "../components/logicwhychoose/page";
    ...
    return (
        <>
            <div className="h-banner lg:py-40 py-20 lg:px-20 px-10 blog-banner ">
                <div className="md:max-w-[1350px] flex gap-16 lg:gap-0  flex-wrap items-center justify-between  mx-auto ">
                    ...
                    <div className="lg:flex-1 flex lg:justify-end justify-center">
                        <Image
                            src={Images.logisticbanner} alt="support" className="object-cover object-center rounded-none w-[80%] " />
                    </div>
                </div>
            </div >
            <Logicwhychoose />
