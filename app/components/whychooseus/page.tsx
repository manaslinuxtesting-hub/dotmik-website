    ...
    return (
        <div className=" lg:px-20 px-10 lg:py-40 py-20">
            <div className="flex w-full relative flex-col gap-3 h-full flex-wrap mx-auto md:max-w-[1350px]">
                ...
                <p className="text-large-36 text-black pb-2 font-semibold" data-aos="fade-up">Creating seamless <span className="text-[#fc9d08]"> e-commerce </span> experiences</p>
                {/* Scrollable Content */}
                <div className=" overflow-visible pt-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-6 justify-between" data-aos="fade-up">
                            <Image
                                src={Icons.genuinesellers}
                                alt="support"
                                width={50}
                                height={50}
                                className="bg-[#fff] p-2 rounded mb-8"
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl text-white leading-none font-bold">Ensure genuine sellers</h4>
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-6 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2 text-tiny-2xl text-white leading-none font-bold">Merchant payout management</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-6 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2 text-tiny-2xl text-white leading-none font-bold">Automate customer payments.</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-6 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2 text-tiny-2xl text-white leading-none font-bold">Process refunds instantly with no delays.</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-6 " data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2 text-tiny-2xl text-white leading-none font-bold">Secure payroll</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-6 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2 text-tiny-2xl text-white leading-none font-bold">Real-time fraud monitoring</h4>
                                <p className="text-xextra-small font-normal text-white">
