        ...
        <nav className="hidden lg:flex gap-8 relative">
         ...
         after:border-r-[10px] after:border-r-transparent"
              >
                ...
                <div className="flex flex-col w-full ">
                  ...
                  <a className="flex-1 bg-[#000] p-2  text-white  rounded-bl-lg rounded-br-lg text-extra-small" href="">Download App</a></div>
              </div>
            )}
          </div>
         ...
         after:border-r-[10px] after:border-r-transparent">
                ...
                <div className="p-2 ">
                  <div >
                    ...
                    {openSubMenu === "banking" && (
                      <div className="px-6 py-6 flex flex-col gap-1 absolute left-full top-0 bg-white w-[520px] p-8 rounded-lg h-full shadow-[0px_1px_4px_0px_#ddd]">
                        <ul className=" grid grid-cols-2 gap-5">
                          <li className=" border border-[#ddd] p-4 rounded-lg flex-1">
                            <Link href="/bankingtech/connectedbanking" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className=" border border-[#ddd] p-4 rounded-lg flex-1">
                            <Link href="/bankingtech/expensecard" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                              ...
                              />
                              Expense Card
                              <p className="text-extra-small pt-1">Manage corporate expenses</p>
                            </Link>
                          </li>
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/bankingtech/gift" className="text-gray-700  font-semibold hover:text-black">
                              <Image
                                src={Icons.giftcard}
                                alt="support"
                                width={50}
                  ...
                  <div>
                    ...
                    {openSubMenu === "payments" && (
                      <div className=" flex flex-col gap-1 absolute left-full top-0 bg-white w-[524px] h-[530px] p-5 rounded-lg h-auto shadow-[0px_1px_4px_0px_#ddd]">
                        <ul className="flex flex-wrap  gap-4">
                          <li className="border border-[#ddd] p-4 rounded-lg">          
                            <Link href="/paymentpaths/singlepayouts" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/paymentpaths/blukpayout" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/paymentpaths/payoutlink" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                                src={Icons.paylink}
                                alt="support"
                                width={50}
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/paymentpaths/utilitypayment" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/paymentpaths/pos" className="text-gray-700  font-semibold hover:text-black">
                              <Image
                                src={Icons.poss}
                                alt="support"
                                width={50}
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/paymentpaths/staticqr" className="text-gray-700  font-semibold hover:text-black">
                              <Image
                                src={Icons.staticqr}
                                alt="support"
                                width={50}
                    ...
                    {openSubMenu === "insurance" && (
                      <div className="pl-6 py-6 flex flex-col gap-1 absolute left-full top-0 bg-white w-[530px] p-8 rounded-lg h-full shadow-[0px_1px_4px_0px_#ddd]">
                        <ul className="flex flex-wrap justify-between gap-5">
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/insurancepath/generalinsurance" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/insurancepath/healthinsurance" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/insurancepath/lifeinsurance" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                                src={Icons.lifeinsu}
                                alt="support"
                                width={50}
                  ...
                  <div>
                    ...
                    {openSubMenu === "identity" && (
                      <div className="pl-6 py-6 flex flex-col gap-1 absolute left-full top-0 bg-white w-[530px] p-8 rounded-lg h-full shadow-[0px_1px_4px_0px_#ddd]">
                        <ul className="flex flex-wrap justify-between gap-5">
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/identityverification/individualverification" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/identityverification/businessverification" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                          ...
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/identityverification/financialverification" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                  ...
                  <div>
                    ...
                    {openSubMenu === "others" && (
                      <div className="pl-6 py-6 flex flex-col gap-1 absolute left-full top-0 bg-white w-[545px] p-8 rounded-lg h-full shadow-[0px_1px_4px_0px_#ddd]">
                        <ul className="flex flex-wrap justify-between gap-5">
                          <li className="border border-[#ddd] p-4 rounded-lg">
                            <Link href="/nextleveloutcomes/bankingagent" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                                src={Icons.bankagent}
                                alt="support"
                                width={50}
                ...
                <div className="flex flex-col w-full ">
                  ...
                  <Link href="" className="flex-1 bg-[#000] p-2  text-white rounded-bl-lg rounded-br-lg text-extra-small">Download App</Link>
                </div>
              </div>
            )}
          </div>
         ...
         after:border-r-[10px] after:border-r-transparent">
                ...
                <div className="flex  w-full ">
                  ...
                  <Link href="" className="flex-1 bg-[#000] p-2  text-white rounded-br-lg text-extra-small">Download App</Link>
                </div>
              </div>
            )}
          </div>
                        ...
                        <ul className="grid grid-cols-2 gap-5">
                          <li className="border border-[#ddd] p-4 rounded-lg flex-1 whitespace-nowrap">
                            <Link href="developerapi" className="text-gray-700 font-semibold hover:text-black">
                              <Image
                                src={Icons.developerapi}
                                alt="support"
                                width={50}
                                height={50}
                                className=" p-2.5  mb-4"
                              />
                              Developer API
                            </Link>
                          </li>
                ...
                <ul className="pl-6 mt-2 flex flex-col gap-1">
                  ...
                  <li>
                    ...
                    {mobileSubMenu.banking && (
                      <ul className="pl-4 mt-1 flex flex-col gap-1">
                        <li><Link href="/bankingtech/connectedbanking" className="block px-2 py-1 hover:bg-gray-700 rounded">Connected Banking</Link></li>
                        <li><Link href="/bankingtech/expensecard" className="block px-2 py-1 hover:bg-gray-700 rounded">Expense Card</Link></li>
                        <li><Link href="/bankingtech/gift" className="block px-2 py-1 hover:bg-gray-700 rounded">Gift Card</Link></li>
                      </ul>
                    )}
                  </li>
                  ...
                  <li>
                    ...
                    {mobileSubMenu.payments && (
                      <ul className="pl-4 mt-1 flex flex-col gap-1">
                        <li><Link href="/paymentpaths/singlepayouts" className="block px-2 py-1 hover:bg-gray-700 rounded">Single Payout</Link></li>
                        <li><Link href="/paymentpaths/blukpayout" className="block px-2 py-1 hover:bg-gray-700 rounded">Bluk Payout</Link></li>
                        <li><Link href="/paymentpaths/payoutlink" className="block px-2 py-1 hover:bg-gray-700 rounded">Payout Link</Link></li>
                        <li><Link href="/paymentpaths/utilitypayment" className="block px-2 py-1 hover:bg-gray-700 rounded">Utility Bill Payments</Link></li>
                        <li><Link href="/paymentpaths/pos" className="block px-2 py-1 hover:bg-gray-700 rounded">Pos</Link></li>
                        <li><Link href="/paymentpaths/staticqr" className="block px-2 py-1 hover:bg-gray-700 rounded">Static QR</Link></li>
                      </ul>
                    )}
                  </li>
                  ...
                  <li>
                    ...
                    {mobileSubMenu.insurance && (
                      <ul className="pl-4 mt-1 flex flex-col gap-1">
                        <li><Link href="/insurancepath/generalinsurance" className="block px-2 py-1 hover:bg-gray-700 rounded">General Insurance</Link></li>
                        <li><Link href="/insurancepath/healthinsurance" className="block px-2 py-1 hover:bg-gray-700 rounded">Health Insurance</Link></li>
                        <li><Link href="/insurancepath/lifeinsurance" className="block px-2 py-1 hover:bg-gray-700 rounded">Life Insurance</Link></li>
                      </ul>
                    )}
                  </li>
                  ...
                  <li>
                    ...
                    {mobileSubMenu.identity && (
                      <ul className="pl-4 mt-1 flex flex-col gap-1">
                        <li><Link href="/identityverification/individualverification" className="block px-2 py-1 hover:bg-gray-700 rounded">Individual Verification</Link></li>
                        <li><Link href="/identityverification/businessverification" className="block px-2 py-1 hover:bg-gray-700 rounded">Business Verification</Link></li>
                        <li><Link href="/identityverification/financialverification" className="block px-2 py-1 hover:bg-gray-700 rounded">Financial Verification</Link></li>
                      </ul>
                    )}
                  </li>
