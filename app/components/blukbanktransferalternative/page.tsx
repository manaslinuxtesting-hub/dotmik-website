...
const Blukbanktransferalternative = () => {
    return (
        <>
            <div className="flex relative lg:py-40 py-20 w-full h-full mx-auto lg:gap-24 items-end justify-between px-10 2xl:container">
                <div className="lg:flex-1">
                    ...
                    <p className="text-small font-normal " data-aos="fade-up">Go beyond basic bank transfers with features designed to boost your business. Get faster
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-14">
                        <div className="flex flex-col" data-aos="fade-up">
                            ...
                            <p className="text-xextra-small  pt-2">Choose from a variety of payment modes including IMPS, NEFT, RTGS, UPI, and Wallets.</p>
                        </div>
                        <div className="flex flex-col" data-aos="fade-up">
                            <Image
                                src={Icons.notped}
                                ...
                                className="bg-[#0000002e] p-2.5 rounded-full mb-6"
                            />
                            <h4 className=" text-tiny-2xl font-semibold leading-none">Bulk Transfers in One Go</h4>
                            <p className="text-xextra-small  pt-2">Use bulk payouts to process thousands of transfers file upload. </p>
                        </div>
                        <div className="flex flex-col mt-8" data-aos="fade-up">
                            ...
                            <p className="text-xextra-small  pt-2">Smart financial reporting lets you find and match any transaction.</p>
                        </div>
                        <div className="flex flex-col mt-8" data-aos="fade-up">
                            <Image
                                src={Icons.notped}
                            ...
                            <p className="text-xextra-small  pt-2">Transactional insights for better cash flow & business decisions.</p>
                        </div>
                    </div>
                </div>
...
export default Blukbanktransferalternative;
