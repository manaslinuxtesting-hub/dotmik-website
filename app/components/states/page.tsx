  ...
  return (
    <section className="relative h-banner contact-banner pt-40 ">
      ...
      <div className="w-full h-full mx-auto md:w-[1350px] mt-8  pb-30">
        ...
        <div className="border border-white rounded-t-none rounded-lg px-8 py-8 flex-1 flex flex-row items-center justify-between  shadow-[0px_1px_4px_0px_#fff] card-hover" data-aos="fade-up">
