        ...
        <div className=" lg:px-20 px-10 lg:py-40 py-20">
            <div className="flex w-full relative gap-20 h-full flex-wrap mx-auto md:max-w-[1350px]">
                ...
                <div className="flex flex-col lg:w-[30%] lg:sticky top-[10px] self-start">
                    <h2 className="pb-6 leading-[1.2] text-large-36 !font-bold text-black" data-aos="fade-up">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            <div className="flex-col">
                                <h4 className="mb-2 text-tiny-2xl font-semibold text-white leading-none pb-2">Virtual / Physical Card Issuance</h4>
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Instant Access To Funds </h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Manage & Protect Card Access</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Tap and Pay</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Accepted across India </h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Set Spending Limits</h4>
                                <p className="text-xextra-small font-normal text-white">
                                     Manage your personal finances & control spending more effectively, with clearer access to your expenses. 
                                </p>
                            </div>
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Receive SMS/Email Updates</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2 t text-tiny-2xl font-semibold text-white leading-none pb-2">Transactions History</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Track Corporate Expense</h4>
                                <p className="text-xextra-small font-normal text-white">
                        ...
                        <div className="flex flex-col gap-2 bg-black rounded-[20px] p-4 justify-between" data-aos="fade-up">
                            ...
                            />
                            <div className="flex-col">
                                <h4 className="mb-2  text-tiny-2xl font-semibold text-white leading-none pb-2">Access Detailed Expense Reports</h4>
                                <p className="text-xextra-small font-normal text-white">
